...
DESCRIPTION = {
    "restaurant": {
        "area": "the location of the restaurant (i.e. centre, north, south, east, west)",
        "pricerange": "the price range of the restaurant (i.e. cheap, moderate, expensive)",
    ...
    "hotel": {
        "area": "the location of the hotel (i.e. centre, north, south, east, west)",
        "internet": "whether the hotel has internet connection",
        "name": "the name of the hotel",
        "parking": "whether the hotel has parking space",
        "pricerange": "the price range of the hotel (i.e. cheap, moderate, expensive)",
        "stars": "the stars of the hotel",
        "type": "the type of the hotel (i.e. bed and breakfast, guesthouse, hotel)",
        "people": "the number of people of the booking",
        "day": "the day when the people go in a week",
        "stay": "the number of days of stay for the reservation",
    },
    "attraction": {
        "area": "the location of the attraction (i.e. centre, north, south, east, west)",
...
FRICTION_TYPES = ["No Friction", "Assumption Reveal", "Reinforcement", "Overspecification", "Probing"]

KEPT_SLOTS_FOR_VERIFIER = {
    "restaurant": ["area", "pricerange", "food", "name", "people", "day", "time"],
    "hotel": ["area", "internet", "name", "parking", "pricerange", "stars", "type", "people", "day", "stay"],
